...
import (
	...
	_ "gitlab.corp.bbbb.com/cloud_infra/elete-go/pkg/elete/sdk"
...
func (Log_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_bbbb_bdp_log_proto_enumTypes[0].Descriptor()
}

func (Log_Type) Type() protoreflect.EnumType {
	return &file_bbbb_bdp_log_proto_enumTypes[0]
}
...
func (Log_Type) EnumDescriptor() ([]byte, []int) {
	return file_bbbb_bdp_log_proto_rawDescGZIP(), []int{0, 0}
}
...
type Log struct {
	...
	Type             Log_Type `protobuf:"varint,1,opt,name=type,proto3,enum=bbbb.bdp.log.Log_Type" json:"type,omitempty"`
...
func (x *Log) Reset() {
	*x = Log{}
	if protoimpl.UnsafeEnabled {
		mi := &file_bbbb_bdp_log_proto_msgTypes[0]
...
func (*Log) Descriptor() ([]byte, []int) {
	return file_bbbb_bdp_log_proto_rawDescGZIP(), []int{0}
}
...
var File_bbbb_bdp_log_proto protoreflect.FileDescriptor

var file_bbbb_bdp_log_proto_rawDesc = []byte{
...
var (
	file_bbbb_bdp_log_proto_rawDescOnce sync.Once
	file_bbbb_bdp_log_proto_rawDescData = file_bbbb_bdp_log_proto_rawDesc
)

func file_bbbb_bdp_log_proto_rawDescGZIP() []byte {
	file_bbbb_bdp_log_proto_rawDescOnce.Do(func() {
		file_bbbb_bdp_log_proto_rawDescData = protoimpl.X.CompressGZIP(file_bbbb_bdp_log_proto_rawDescData)
	})
	return file_bbbb_bdp_log_proto_rawDescData
}

var file_bbbb_bdp_log_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_bbbb_bdp_log_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_bbbb_bdp_log_proto_goTypes = []interface{}{
	(Log_Type)(0),       // 0: bbbb.bdp.log.Log.Type
	(*Log)(nil),         // 1: bbbb.bdp.log.Log
	(*empty.Empty)(nil), // 2: google.protobuf.Empty
}
var file_bbbb_bdp_log_proto_depIdxs = []int32{
	0, // 0: bbbb.bdp.log.Log.type:type_name -> bbbb.bdp.log.Log.Type
	1, // 1: bbbb.bdp.log.LogReceiver.SendLogMessage:input_type -> bbbb.bdp.log.Log
	2, // 2: bbbb.bdp.log.LogReceiver.SendLogMessage:output_type -> google.protobuf.Empty
...
func init() { file_bbbb_bdp_log_proto_init() }
func file_bbbb_bdp_log_proto_init() {
	if File_bbbb_bdp_log_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_bbbb_bdp_log_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Log); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_bbbb_bdp_log_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_bbbb_bdp_log_proto_goTypes,
		DependencyIndexes: file_bbbb_bdp_log_proto_depIdxs,
		EnumInfos:         file_bbbb_bdp_log_proto_enumTypes,
		MessageInfos:      file_bbbb_bdp_log_proto_msgTypes,
	}.Build()
	File_bbbb_bdp_log_proto = out.File
	file_bbbb_bdp_log_proto_rawDesc = nil
	file_bbbb_bdp_log_proto_goTypes = nil
	file_bbbb_bdp_log_proto_depIdxs = nil
}
...
func (c *logReceiverClient) SendLogMessage(ctx context.Context, in *Log, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/bbbb.bdp.log.LogReceiver/SendLogMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LogReceiver_SendLogMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bbbb.bdp.log.LogReceiver/SendLogMessage",
	}
...
var _LogReceiver_serviceDesc = grpc.ServiceDesc{
	ServiceName: "bbbb.bdp.log.LogReceiver",
