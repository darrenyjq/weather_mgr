...
type VerifyResult struct {
	Result               TokenStatus   `protobuf:"varint,1,opt,name=result,proto3,enum=bbbb.account.TokenStatus" json:"result,omitempty"`
	UserId               uint64        `protobuf:"varint,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	AccountType          AccountType   `protobuf:"varint,3,opt,name=account_type,json=accountType,proto3,enum=bbbb.account.AccountType" json:"account_type,omitempty"`
	...
	AccountRegion        AccountRegion `protobuf:"varint,8,opt,name=account_region,json=accountRegion,proto3,enum=bbbb.account.AccountRegion" json:"account_region,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
type FullTokenInfo struct {
	...
	AccountName          string          `protobuf:"bytes,7,opt,name=account_name,json=accountName,proto3" json:"account_name,omitempty"`
	AccountRegion        AccountRegion   `protobuf:"varint,8,opt,name=account_region,json=accountRegion,proto3,enum=bbbb.account.AccountRegion" json:"account_region,omitempty"`
	MediaSource          MediaSource     `protobuf:"varint,9,opt,name=media_source,json=mediaSource,proto3,enum=bbbb.account.MediaSource" json:"media_source,omitempty"`
...
type ActivationInfo struct {
	ActivateType         ActivateType `protobuf:"varint,1,opt,name=activate_type,json=activateType,proto3,enum=bbbb.account.ActivateType" json:"activate_type,omitempty"`
	UserId               uint64       `protobuf:"varint,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
...
func init() {
	proto.RegisterEnum("bbbb.account.TokenStatus", TokenStatus_name, TokenStatus_value)
	proto.RegisterEnum("bbbb.account.AccountType", AccountType_name, AccountType_value)
	proto.RegisterEnum("bbbb.account.AccountRegion", AccountRegion_name, AccountRegion_value)
	proto.RegisterEnum("bbbb.account.MediaSource", MediaSource_name, MediaSource_value)
	proto.RegisterEnum("bbbb.account.ActivateType", ActivateType_name, ActivateType_value)
	proto.RegisterType((*TokenIn)(nil), "bbbb.account.TokenIn")
	proto.RegisterType((*VerifyResult)(nil), "bbbb.account.VerifyResult")
	proto.RegisterType((*FullTokenInfo)(nil), "bbbb.account.FullTokenInfo")
	proto.RegisterType((*ActivationInfo)(nil), "bbbb.account.ActivationInfo")
}
...
func (c *tokenServiceClient) VerifyToken(ctx context.Context, in *TokenIn, opts ...grpc.CallOption) (*VerifyResult, error) {
	...
	err := c.cc.Invoke(ctx, "/bbbb.account.TokenService/VerifyToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tokenServiceClient) QueryFullInfo(ctx context.Context, in *TokenIn, opts ...grpc.CallOption) (*FullTokenInfo, error) {
	...
	err := c.cc.Invoke(ctx, "/bbbb.account.TokenService/QueryFullInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TokenService_VerifyToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bbbb.account.TokenService/VerifyToken",
	}
...
func _TokenService_QueryFullInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bbbb.account.TokenService/QueryFullInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _TokenService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "bbbb.account.TokenService",
